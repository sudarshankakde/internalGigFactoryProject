                                        ...
                                        <div className="divide-y divide-[#1c1c24] space-y-3">
                                          {milestone.deliverables.map(
                                            (deliv, dIdx) => (
                                              <div
                                                key={deliv.id}
                                                className={`text-xs space-y-1.5 ${dIdx > 0 ? "pt-3" : ""}`}
                                              >
                                  ...
                                  {milestone.reviews &&
                                    milestone.reviews.length > 0 && (
                                      <div className="space-y-3 border-t border-[#1c1c24] pt-3">
                                        ...
                                        <div className="divide-y divide-[#1c1c24] space-y-3">
                                          {milestone.reviews.map(
                                            (rev, rIdx) => (
                                              <div
                                                key={rev.id}
                                                className={`text-xs space-y-1.5 ${rIdx > 0 ? "pt-3" : ""}`}
                                              >
                                                <div className="flex justify-between items-center text-gray-300">
                                                  <span className="font-bold flex items-center gap-1.5">
                                                    <span
                                                      className={`w-1.5 h-1.5 rounded-full ${rev.status === "approved" ? "bg-[#70d64d]" : "bg-red-400"}`}
                                                    />
                                                    {rev.status === "approved"
                                                      ? "Approved"
                                                      : "Revision Requested"}
            ...
            {isAssigned ? (
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-500 text-[10.5px] leading-relaxed mt-2 italic border-t border-[#23232a] pt-3">
                  You are officially assigned as the executor of this project.
                  Track milestone statuses and submit deliverables for review
                  below.
                </p>
              </div>
            ) : myApplication ? (
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-500 text-[10.5px] leading-relaxed mt-2 italic">
                  You have successfully submitted your execution strategy. The
                  admin will review it and notify you via email when a decision
                  is made.
                </p>
              </div>
            ) : isProjectCompleted ? (
              ...
              <div className="space-y-4">
                <div className="mb-4">
                  ...
                  <p className="text-gray-500 text-xs mt-1 leading-relaxed">
                    Submit your execution strategy and commercial bid to the
                    platform.
                  </p>
                </div>
